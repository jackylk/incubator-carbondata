...
class NoDictionaryColumnTestCase extends QueryTest with BeforeAndAfterAll {
  ...
  override def beforeAll {
    ...
    sql("CREATE TABLE carbonTable (imei String, age Int, num BigInt) STORED AS carbondata TBLPROPERTIES('DICTIONARY_INCLUDE'='age,num')")
    ...
    sql("CREATE TABLE carbonEmpty (cust_id int, cust_name String, active_emui_version String, bob timestamp, bigint_column bigint) STORED AS carbondata TBLPROPERTIES('DICTIONARY_EXCLUDE'='cust_name,active_emui_version')")
