...
class JoinWithoutDictionaryColumn extends QueryTest with BeforeAndAfterAll {
  ...
  override def beforeAll {
    ...
    sql(
      """
        create table mobile (mid String,Mobileid String, Color String, id int) STORED AS carbondata TBLPROPERTIES('DICTIONARY_EXCLUDE'='Color')
      """)
    sql(
      """
        create table emp (eid String,ename String, Mobileid String,Color String, id int) STORED AS carbondata TBLPROPERTIES('DICTIONARY_EXCLUDE'='Color')
      """)

    sql(
      """
        create table mobile_d (mid String,Mobileid String, Color String, id int) STORED AS carbondata TBLPROPERTIES('DICTIONARY_EXCLUDE'='Color','DICTIONARY_INCLUDE'='Mobileid')
      """)
    sql(
      """
        create table emp_d (eid String,ename String, Mobileid String,Color String, id int) STORED AS carbondata TBLPROPERTIES('DICTIONARY_EXCLUDE'='Color','DICTIONARY_INCLUDE'='Mobileid')
      """)
