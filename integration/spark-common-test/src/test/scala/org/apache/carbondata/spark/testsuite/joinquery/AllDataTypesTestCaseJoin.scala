...
class AllDataTypesTestCaseJoin extends QueryTest with BeforeAndAfterAll {
  ...
  test("Union with alias fails") {
    ...
    sql("CREATE TABLE carbon_table1(shortField smallint,intField int,bigintField bigint,doubleField double,stringField string,timestampField timestamp,decimalField decimal(18,2),dateField date,charField char(5),floatField float) STORED AS carbondata TBLPROPERTIES('DICTIONARY_INCLUDE'='dateField, charField')")

    sql("CREATE TABLE carbon_table2(shortField smallint,intField int,bigintField bigint,doubleField double,stringField string,timestampField timestamp,decimalField decimal(18,2),dateField date,charField char(5),floatField float) STORED AS carbondata TBLPROPERTIES('DICTIONARY_INCLUDE'='dateField, charField')")
