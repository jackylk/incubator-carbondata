...
class TestDimensionWithDecimalDataType extends QueryTest with BeforeAndAfterAll {
  ...
  override def beforeAll {
    ...
    sql("CREATE TABLE IF NOT EXISTS carbonTable (ID Int, date Timestamp, country String, name String, phonetype String, serialname String, salary Decimal(19,2))STORED AS carbondata TBLPROPERTIES('DICTIONARY_INCLUDE'='salary')")
