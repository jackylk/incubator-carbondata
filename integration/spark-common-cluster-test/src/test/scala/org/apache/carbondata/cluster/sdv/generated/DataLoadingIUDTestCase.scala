...
test("IUD-01-01-01_005-12", Include) {
   sql(s"""drop table IF EXISTS default.t_carbn01 """).collect
 sql(s"""create table default.t_carbn01 (Item_type_cd INT, Profit DECIMAL(3,2))STORED AS carbondata TBLPROPERTIES('DICTIONARY_INCLUDE'='Item_type_cd')""").collect
...
test("IUD-01-01-02_023-18", Include) {
 ...
 sql(s"""create table t_carbn1(item_type_cd int, sell_price bigint, profit decimal(10,4), item_name string, update_time timestamp) STORED AS carbondata TBLPROPERTIES('DICTIONARY_INCLUDE'='sell_price')""").collect
 ...
 sql(s"""create table t_carbn2(item_type_cd int, sell_price bigint, profit decimal(10,4), item_name string, update_time timestamp) STORED AS carbondata TBLPROPERTIES('DICTIONARY_INCLUDE'='sell_price')""").collect
