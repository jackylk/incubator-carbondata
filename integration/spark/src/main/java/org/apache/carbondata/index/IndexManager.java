...
import org.apache.carbondata.core.index.IndexProvider;
...
public class IndexManager {
   ...
   */
  public IndexProvider getIndexProvider(CarbonTable mainTable, IndexSchema indexSchema,
      SparkSession sparkSession) throws MalformedIndexCommandException {
    org.apache.carbondata.core.index.IndexProvider provider;
    if (indexSchema.getProviderName().equalsIgnoreCase(IndexClassProvider.MV.toString())) {
      provider = (org.apache.carbondata.core.index.IndexProvider) CarbonScalaUtil.createDataMapProvider(
          "org.apache.carbondata.mv.extension.MVDataMapProvider",
              sparkSession,
              mainTable, indexSchema);
    } else {
      provider = new org.apache.carbondata.index.IndexProvider(mainTable, indexSchema, sparkSession);
    }
    return provider;
  }
