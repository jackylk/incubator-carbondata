...
public final class ProxyFileSystem extends FileSystem {
    ...
    @Override
    public BlockLocation[] getFileBlockLocations(final FileStatus fileStatus, final long offset, final long length) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public boolean rename(final Path path, final Path path1) {
        throw new UnsupportedOperationException();
    }
