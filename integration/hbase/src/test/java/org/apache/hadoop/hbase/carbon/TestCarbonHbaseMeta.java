...
public class TestCarbonHbaseMeta {
  ...
  static String schemaStr = "{\"ID\":\"string\", \"name\":\"string\",\"salary\":\"double\", \"timestamp\":\"timestamp\",\"deletestatus\":\"long\",\"tblproperties\": {\"sort_columns\":\"ID\", \"hbase_mapping\":\"key=ID,cf:name=name,timestamp=timestamp,cf:salary=salary,deletestatus=deletestatus\"}}";
