...
import org.apache.carbondata.core.datamap.index.IndexChooser;
import org.apache.carbondata.core.datamap.index.IndexFilter;
import org.apache.carbondata.core.datamap.index.IndexJob;
...
m filterExpression
  ...
  protected IndexFilter getFilterPredicates(Configuration configuration) {
    try {
      ...
      if (isFgDataMapPruningEnable(job.getConfiguration()) && indexJob != null) {
        ...
        if (fgDataMapExprWrapper != null) {
          ...
          fgPrunedBlocklets = IndexUtil
              .executeIndexJob(carbonTable, filter.getResolver(), indexJob, partitionsToPrune,
                  segmentIds, invalidSegments, fgDataMapExprWrapper.getIndexLevel(),
