...
public class LearnedRowParserImpl implements RowParser {
  ...
  public LearnedRowParserImpl(DataField[] output, CarbonDataLoadConfiguration configuration) {
    ...
    numberOfSortColumns = configuration.getNumberOfSortColumns();
  }
  ...
  @Override public Object[] parseRow(Object[] row) {
    ...
    Object[] out = new Object[numberOfSortColumns];
