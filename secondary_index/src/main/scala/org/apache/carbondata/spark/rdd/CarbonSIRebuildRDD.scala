...
class CarbonSIRebuildRDD[K, V](
  ...
  val indexTablePath = carbonMergerMapping.hdfsStoreLocation
  val databaseName = carbonMergerMapping.databaseName
  val indexTableName = carbonMergerMapping.factTableName
  val indexTableId = carbonMergerMapping.tableId
  ...
  override def internalCompute(theSplit: Partition,
    ...
    val iter = new Iterator[(K, V)] {
      ...
      try {
        ...
        CommonUtil.setTempStoreLocation(theSplit.index, carbonLoadModelCopy, true, false)
