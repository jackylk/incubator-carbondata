...
public abstract class NotLessThanExpression<TParameter extends Comparable<TParameter>>
    extends Evaluation<Boolean> implements Function<Boolean>, Comparison<TParameter> {

  public static final String NAME = ">=";

  public NotLessThanExpression(final Evaluation<TParameter> parameter1, final Evaluation<TParameter> parameter2) {
  ...
  @Name(NAME)
  public static final class ForBoolean extends NotLessThanExpression<Boolean> {
  ...
  @Name(NAME)
  public static final class ForBytes extends NotLessThanExpression<Bytes> {
  ...
  @Name(NAME)
  public static final class ForDate extends NotLessThanExpression<Date> {
  ...
  @Name(NAME)
  public static final class ForDecimal4 extends NotLessThanExpression<Float> {
  ...
  @Name(NAME)
  public static final class ForDecimal8 extends NotLessThanExpression<Double> {
  ...
  @Name(NAME)
  public static final class ForDecimal extends NotLessThanExpression<BigDecimal> {
  ...
  @Name(NAME)
  public static final class ForInteger1 extends NotLessThanExpression<Byte> {
  ...
  @Name(NAME)
  public static final class ForInteger2 extends NotLessThanExpression<Short> {
  ...
  @Name(NAME)
  public static final class ForInteger4 extends NotLessThanExpression<Integer> {
  ...
  @Name(NAME)
  public static final class ForInteger8 extends NotLessThanExpression<Long> {
  ...
  @Name(NAME)
  public static final class ForInteger extends NotLessThanExpression<BigInteger> {
  ...
  @Name(NAME)
  public static final class ForString extends NotLessThanExpression<String> {
  ...
  @Name(NAME)
  public static final class ForTimestamp extends NotLessThanExpression<Timestamp> {
  ...
  @Name(NAME)
  public static final class ForTime extends NotLessThanExpression<Time> {
