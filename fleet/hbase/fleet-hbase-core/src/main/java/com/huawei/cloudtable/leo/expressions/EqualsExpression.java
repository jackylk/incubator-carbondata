...
public abstract class EqualsExpression<TParameter extends Comparable<TParameter>> extends Evaluation<Boolean>
    implements Function<Boolean>, Comparison<TParameter>, Commutative<TParameter, TParameter> {

  public static final String NAME = "=";

  public EqualsExpression(final Evaluation<TParameter> parameter1, final Evaluation<TParameter> parameter2) {
  ...
  public static final class ForBoolean extends EqualsExpression<Boolean> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForBytes extends EqualsExpression<Bytes> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForDate extends EqualsExpression<Date> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForDecimal4 extends EqualsExpression<Float> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForDecimal8 extends EqualsExpression<Double> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForDecimal extends EqualsExpression<BigDecimal> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForInteger1 extends EqualsExpression<Byte> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForInteger2 extends EqualsExpression<Short> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForInteger4 extends EqualsExpression<Integer> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForInteger8 extends EqualsExpression<Long> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForInteger extends EqualsExpression<BigInteger> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForString extends EqualsExpression<String> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForTimestamp extends EqualsExpression<Timestamp> {
  ...
  @Name(EqualsExpression.NAME)
  public static final class ForTime extends EqualsExpression<Time> {
