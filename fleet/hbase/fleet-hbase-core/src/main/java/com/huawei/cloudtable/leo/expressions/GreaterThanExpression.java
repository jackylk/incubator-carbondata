...
public abstract class GreaterThanExpression<TParameter extends Comparable<TParameter>>
    extends Evaluation<Boolean> implements Function<Boolean>, Comparison<TParameter> {

  public static final String NAME = ">";

  public GreaterThanExpression(final Evaluation<TParameter> parameter1, final Evaluation<TParameter> parameter2) {
    ...
    try {
      switch (variableIndex) {
        case 0: {
          ...
          if (constant != null) {
            return ValueRange.of(constant, false, null, false);
          }
          break;
        }
        case 1: {
  ...
  @Name(NAME)
  public static final class ForBoolean extends GreaterThanExpression<Boolean> {
  ...
  @Name(NAME)
  public static final class ForBytes extends GreaterThanExpression<Bytes> {
  ...
  @Name(NAME)
  public static final class ForDate extends GreaterThanExpression<Date> {
  ...
  @Name(NAME)
  public static final class ForDecimal4 extends GreaterThanExpression<Float> {
  ...
  @Name(NAME)
  public static final class ForDecimal8 extends GreaterThanExpression<Double> {
  ...
  @Name(NAME)
  public static final class ForDecimal extends GreaterThanExpression<BigDecimal> {
  ...
  @Name(NAME)
  public static final class ForInteger1 extends GreaterThanExpression<Byte> {
  ...
  @Name(NAME)
  public static final class ForInteger2 extends GreaterThanExpression<Short> {
  ...
  @Name(NAME)
  public static final class ForInteger4 extends GreaterThanExpression<Integer> {
  ...
  @Name(NAME)
  public static final class ForInteger8 extends GreaterThanExpression<Long> {
  ...
  @Name(NAME)
  public static final class ForInteger extends GreaterThanExpression<BigInteger> {
  ...
  @Name(NAME)
  public static final class ForString extends GreaterThanExpression<String> {
  ...
  @Name(NAME)
  public static final class ForTimestamp extends GreaterThanExpression<Timestamp> {
  ...
  @Name(NAME)
  public static final class ForTime extends GreaterThanExpression<Time> {
